...
**Отчеты Fastqc:**
*  1) Для ENCFF974MOD все харатеристики оказались в норме, все зеленые галочки кроме двух оранжевых восклицательных знака Per sequence GC content и Overrepresented sequences, что не является критичным. Из отчета видим, что для Per sequence GC content рапспределение не идеальное, но близко к нормальному. Главное, что Per base sequence quality полностью в норме. Basic statistic говорит что %GC составляет 48.
<p float='left'>
...
По картинке видим, что в Per tile sequence появился небольшой голубой прямоугольник, где качество хуже, но такие небольшие отклонения считаются в пределах нормы. Basic statistic снова показывает GC содержание 48%.
<p float='left'>
...
Процент выравниваний как мы видим очень небольшой, что скорее всего связано с тем, что мы вырывнивали только на одну хромосому 14 из-за того что ресурсы google colab ограничены.
...
для bigwig файлов ENCFF672IAE и ENCFF749GHM, соответсвующие bam файлам ENCFF242PMY.bam и ENCFF098OBN.bam, слева общий вид, а справа приближено там, где лучше видны характерные особенности.
<p float='left'>
